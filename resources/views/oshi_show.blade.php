...
<div class="container">
  <div class="card">
    <div class="card-body d-flex">
      <aside class='oshi-image col-md-4'>
      ...
      <section class='oshi-main'>
        <h2 class='h2'>名前</h2>
        <p class='h4 mb20'>{{ $oshi_infos->name }}</p>
        <h2 class='h2'>所属チーム</h2>
        <p class='h4 mb20'>{{ $oshi_infos->belong_team }}</p>
        <h2 class='h2'>誕生日</h2>
        <p class='h4 mb20'>{{ $oshi_infos->birthday }}</p>
        <h2 class='h2'>沼に落ちた日</h2>
        <p class='h4 mb20'>{{ $oshi_infos->start_recomend_at }}</p>
      </section>
      </div>
    <div class="d-flex justify-content-start">
      <a href="{{ route('index') }}" class='btn btn-info btn-back mb20'>一覧へ戻る</a>
      <a href="{{ route('edit', ['id' => $oshi_infos->id ]) }}" class='btn btn-secondary btn-back mb20'><i class="fas fa-edit"></i>編集</a>
    </div>
  </div>
<div class="tab_wrap">
	...
	<div class="tab_area">
		<label class="tab1_label" for="tab1">Twitter情報</label>
		<label class="tab2_label" for="tab2">メディア情報</label>
